...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO user (id_user,username,password,usertype)VALUES ( ' ','$myusername','$mypassword','$myusertype')";
    ...
    // }
    // else {
    //    echo "<script type='text/javascript'> alert('Proses pendaftaran gagal'); </script> ";
...
<body>
    <form action="#" method="POST">
        ...
        <input type="password" name="pass2" placeholder="Password" id="password">
        
        <input type="submit" name="submit" class="register">
        <a href="./login.php" class="login"> Sudah Punya Akun? Login Sekarang </a>
    </form>
</body>
</html>
